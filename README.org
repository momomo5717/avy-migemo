...
** Table of contents
  ...
  + [[#customization][Customization]]
    ...
    + [[#an-example-of-setting-for-counsel][An example of setting for counsel]]
...
***** An example of setting for swiper ( =ivy--regex= )
      ...
      #+END_SRC
***** An example of setting for counsel

      avy-migemo-e.g.counsel.el is a setting file for counsel.el.
